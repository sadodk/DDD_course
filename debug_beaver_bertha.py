...
def debug_beaver_bertha_pricing():
    ...
    scenarios = [
        ("Default customer", VisitorInfo("Beaver Bertha", "individual", "123 Street", "", "CARD1", "test@example.com")),
        ("Individual from unknown city", VisitorInfo("Beaver Bertha", "individual", "123 Street", "Unknown City", "CARD1", "test@example.com")),
        ("Business from unknown city", VisitorInfo("Beaver Bertha", "business", "123 Street", "Unknown City", "CARD1", "test@example.com")),
        ("Individual from Oak City", VisitorInfo("Beaver Bertha", "individual", "123 Street", "Oak City", "CARD1", "test@example.com")),
        ("Business from Oak City", VisitorInfo("Beaver Bertha", "business", "123 Street", "Oak City", "CARD1", "test@example.com")),
    ]
    ...
    for scenario_name, mock_visitor in scenarios:
        ...
        with patch.object(app.visitor_service, 'get_visitor_by_id', return_value=mock_visitor):
            try:
                ...
                fraction = DroppedFraction(FractionType.CONSTRUCTION_WASTE, Weight(1803))
